...
SELECT
  ...
  flat_duration AS delivery_duration_min,
-- Calculate speed
  ROUND(
...
FROM dist_duration_fix 
INNER JOIN pizza_runner.customer_orders
  ON dist_duration_fix.order_id = customer_orders.order_id
INNER JOIN order_rating -- Join with new table to capture order ratings.
  ON dist_duration_fix.order_id = order_rating.order_id
...
GROUP BY
  ...
  speed_km_hr;
```
| order_id | customer_id | runner_id | rating | order_time               | pickup_time              | order_prep_time | delivery_duration_min | speed_km_hr | pizza_count |
|----------|-------------|-----------|--------|--------------------------|--------------------------|-----------------|-----------------------|-------------|-------------|
| 1        | 101         | 1         | 2      | 2021-01-01T18:05:02.000Z | 2021-01-01T18:15:34.000Z | 10              | 32                    | 37.50       | 1           |
| 2        | 101         | 1         | 3      | 2021-01-01T19:00:52.000Z | 2021-01-01T19:10:54.000Z | 10              | 27                    | 44.44       | 1           |
| 3        | 102         | 1         | 2      | 2021-01-02T23:51:23.000Z | 2021-01-03T00:12:37.000Z | 21              | 20                    | 40.20       | 2           |
| 4        | 103         | 2         | 2      | 2021-01-04T13:23:46.000Z | 2021-01-04T13:53:03.000Z | 29              | 40                    | 35.10       | 3           |
| 5        | 104         | 3         | 3      | 2021-01-08T21:00:29.000Z | 2021-01-08T21:10:57.000Z | 10              | 15                    | 40.00       | 1           |
| 7        | 105         | 2         | 4      | 2021-01-08T21:20:29.000Z | 2021-01-08T21:30:45.000Z | 10              | 25                    | 60.00       | 1           |
| 8        | 102         | 2         | 4      | 2021-01-09T23:54:33.000Z | 2021-01-10T00:15:02.000Z | 20              | 15                    | 93.60       | 1           |
| 10       | 104         | 1         | 5      | 2021-01-11T18:34:49.000Z | 2021-01-11T18:50:20.000Z | 15              | 10                    | 60.00       | 2           |
